...
player.play()*/
  ...
  func webView(_ webview: WKWebView, didFinish navigation: WKNavigation!) {
    ...
    webview.evaluateJavaScript("var el = document.querySelector('meta[name=viewport]'); if (el !== null) { el.setAttribute('content', 'width=device-width, initial-scale=1, minimum-scale=0, maximum-scale=10, user-scalable=yes'); }", completionHandler: nil)
